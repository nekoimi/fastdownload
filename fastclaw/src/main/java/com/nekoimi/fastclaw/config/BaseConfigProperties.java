package com.nekoimi.fastclaw.config;

import com.nekoimi.fastclaw.logger.LoggerFactory;
import com.nekoimi.fastclaw.utils.BoolUtils;
import com.nekoimi.fastclaw.utils.NumberUtils;
...
public abstract class BaseConfigProperties extends Properties implements ConfigProperties {
    ...
    public void initialization() {
        InputStream resourceAsStream = getClass().getResourceAsStream(configPath());
